...
;
 ...
 class DefaultChangeLogParser extends Object implements ChangeLogParser{
...
'));$log->addRelease($release);} while (NULL !== $l);;} catch (Exception $··e) {}try { $reader->close(); } catch (Exception $··i) {}if ($··e) throw $··e;;return $log;}}xp::$cn['DefaultChangeLogParser']= 'net.xp_framework.build.DefaultChangeLogParser';xp::$meta['net.xp_framework.build.DefaultChangeLogParser']= array (
  0 => 
  array (
  ),
  1 => 
