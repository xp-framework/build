...
'));$log->addRelease($release);} while (NULL !== $l);;} catch (Exception $··e) {}try { $reader->close(); } catch (Exception $··i) {}if ($··e) throw $··e;;return $log;}}xp::$registry['class.ChangeLogParser']= 'net.xp_framework.build.ChangeLogParser';xp::$registry['details.net.xp_framework.build.ChangeLogParser']= array (
  0 => 
  array (
  ),
  1 => 
