...
'));$log->addRelease($release);} while (NULL !== $l);;} catch (\Exception$··e) {}try { $reader->close(); } catch (\Exception $··i) {}if ($··e) throw $··e;;return $log;}}\xp::$cn['net\xp_framework\build\MarkdownChangeLogParser']= 'net.xp_framework.build.MarkdownChangeLogParser';\xp::$meta['net.xp_framework.build.MarkdownChangeLogParser']= array(0 => array(), 1 => array('parse' => array(1 => array(0 => 'io.streams.InputStream'), 2 => 'net.xp_framework.build.ChangeLog', 3 => array(), 4 => 'Parse ChangeLog file', 5 => array(), 6 => array())), 'class' => array(4 => 'Parses markdown changelog from an input stream
